 ...
 /*  echo "<table border='2'style='width:100%'>
   //       <tr>
     //     <th>Lead ID </th>
      ...
      ?>
      <br>
          <form  action="visadb.php" method="Post">
      <div class="row">
      <div class="col-md-10">
      <?php 
 ...
 <div class="row">
      ...
      <div class="col-md-8">
            <select name="status" class="form-control">
              ...
              <option value="Awaiting VISA Docs">Awaiting VISA Docs</option>
              <option value="VISA Granted">VISA Granted</option>
              <option value="VISA Declined">VISA Declined</option>
            </select>
      </div>
    </div>
