...
<html lang="en">
<head>
  <title>Admin Management-Add a Student</title>
...
<form action="student_process.php" method="post">
       <!--  <div class="bg-light mt-3 px-2 member_frm" style="border-radius: 5px; border: solid maroon"> -->
        <div class="row">
         <div class="col-md-10">
          <h1>SIGN UP</h1>
            <h2>Please enter Student - Login profile</h2>
            ...
            <div class="row">
              <div class="col-md-2">
                  <label for="number">* Mobile Number:</label></div>
                   <div class="col-md-8">
                    <input type="number" id="number" name="number" size="10" maxlength="11" placeholder="10 digits" class="form-control"
