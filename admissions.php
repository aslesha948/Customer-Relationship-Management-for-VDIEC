...
$conn = db_connect();
  ...
  $qry = "SELECT * FROM `leads` WHERE `Status` NOT IN ('Hot','Cold','Warm','Not applied')";
   ...
   echo "<table border='2'style='width:100%'>
    ...
    while ($cleads = mysqli_fetch_array($res)) 
    {
      ...
      echo "<tr>";
            ...
            echo "<td><a href=\"admUpdate.php?cid=".$contact."\"><button type=\"button\" class=\"btn btn-warning\" style=\"float:right\" >Edit</button></a></td>";
